...
public class RegisteredEventConfig {
    ...
    public static final String event_attendedstatus="AttendedStatus";
    public static final String event_paybackstatus="RefundStatus";
    public static final String event_certificatestatus="CertificateStatus";
    public static final String event_indetails_url="https://jbgroup.org.in/sync/sync_mapp/iq_php/event_full_details.php";
    public static final String new_event_indetails_url="https://jbgroup.org.in/sync/sync_mapp/iq_php/new_event_full_details.php";
    public static final String new_get_into_team="https://jbgroup.org.in/sync/sync_mapp/iq_php/getintoteam.php";
    public static final String delete_event_url="https://jbgroup.org.in/sync/sync_mapp/iq_php/deleteevent.php";
